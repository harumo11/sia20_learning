...
int main(int argc, char* argv[])
{
    ...
    // 8th layer
    dynet::Parameter p_W8 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W8");
    dynet::Parameter p_b8 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b8");
    // 9th layer
    dynet::Parameter p_W9 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W9");
    dynet::Parameter p_b9 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b9");
    // 10th layer
    dynet::Parameter p_W10 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W10");
    dynet::Parameter p_b10 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b10");
    // 11th layer
    dynet::Parameter p_W11 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W11");
    dynet::Parameter p_b11 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b11");
    // 12th layer
    dynet::Parameter p_W12 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W12");
    dynet::Parameter p_b12 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b12");
    // 13th layer
    dynet::Parameter p_W13 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W13");
    dynet::Parameter p_b13 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b13");
    // 14th layer
    dynet::Parameter p_W14 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W14");
    dynet::Parameter p_b14 = parameter_collection.add_parameters({ HIDEN_LAYER_DIMENSION }, 0, "b14");
    // 15th layer
    dynet::Parameter p_W15 = parameter_collection.add_parameters({ OUTPUT_LAYER_DIMENSION, HIDEN_LAYER_DIMENSION }, 0, "W15");
    dynet::Parameter p_b15 = parameter_collection.add_parameters({ OUTPUT_LAYER_DIMENSION }, 0, "b15");
    ...
    // 9th layer
    dynet::Expression W9 = dynet::parameter(computation_graph, p_W9);
    dynet::Expression b9 = dynet::parameter(computation_graph, p_b9);
    // 10th layer
    dynet::Expression W10 = dynet::parameter(computation_graph, p_W10);
    dynet::Expression b10 = dynet::parameter(computation_graph, p_b10);
    // 11th layer
    dynet::Expression W11 = dynet::parameter(computation_graph, p_W11);
    dynet::Expression b11 = dynet::parameter(computation_graph, p_b11);
    // 12th layer
    dynet::Expression W12 = dynet::parameter(computation_graph, p_W12);
    dynet::Expression b12 = dynet::parameter(computation_graph, p_b12);
    // 13th layer
    dynet::Expression W13 = dynet::parameter(computation_graph, p_W13);
    dynet::Expression b13 = dynet::parameter(computation_graph, p_b13);
    // 14th layer
    dynet::Expression W14 = dynet::parameter(computation_graph, p_W14);
    dynet::Expression b14 = dynet::parameter(computation_graph, p_b14);
    // 15th layer(output layer)
    dynet::Expression W15 = dynet::parameter(computation_graph, p_W15);
    dynet::Expression b15 = dynet::parameter(computation_graph, p_b15);
    ...
    dynet::Expression z13 = dynet::rectify(W13 * z12 + b13);
    dynet::Expression z14 = dynet::rectify(W14 * z13 + b14);
    dynet::Expression y_pred = W15 * z14 + b15;
    ...
    // モデルを保存
    dynet::TextFileSaver saver("train4.model");
